import { AddressDto, AddressUpdateDto, CustomerCategoryDto, PreferencesDto, UpdateCustomerCategoryDto, UserDto } from './user.entity';
...
export interface UserUsecase {
    ...
    assignCustomersToCategory(customerIds: string[], customerCategoryId: string): Promise<any>;
